/**
 * StringTok API - Entry Point
 * 
 * The official REST API server for StringTok
...
async function start() {
  console.log('Starting StringTok API...');
  ...
  app.listen(config.port, () => {
    console.log(`
StringTok API v1.0.0
-------------------
Environment: ${config.nodeEnv}
Port: ${config.port}
Base URL: ${config.stringtok.baseUrl}
...
Documentation: https://www.stringtok.com/skill.md
    `);
  });
}
